package com.huijia.sharing.module.link.aspect;
...
import com.huijia.sharing.module.link.model.enums.RefererTypeEnum;
...
public class RefererCheckAspect {
	 ...
	 * @return  方法运行结果
	 */
	@Around(value = "@annotation(com.huijia.sharing.module.storage.annotation.RefererCheck)")
