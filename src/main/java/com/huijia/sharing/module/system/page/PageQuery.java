package com.huijia.sharing.module.system.page;
...
import com.huijia.sharing.module.system.utils.SqlUtil;
...
public class PageQuery implements Serializable {
    ...
    private List<OrderItem> buildOrderItem() {
        ...
        if (isAscArr.length != 1 && isAscArr.length != orderByArr.length) {
            throw new ServiceException("排序参数有误", CodeMsg.BAD_REQUEST);
        }
