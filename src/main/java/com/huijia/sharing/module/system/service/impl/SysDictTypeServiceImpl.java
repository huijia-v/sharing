...
import com.huijia.sharing.module.system.mapper.SysDictDataMapper;
import com.huijia.sharing.module.system.mapper.SysDictTypeMapper;
...
import com.huijia.sharing.module.system.service.DictService;
import com.huijia.sharing.module.system.service.ISysDictTypeService;
import com.huijia.sharing.module.system.utils.SpringUtils;
    ...
    public void deleteDictTypeByIds(Long[] dictIds) {
        for (Long dictId : dictIds) {
            ...
            if (dictDataMapper.exists(new LambdaQueryWrapper<SysDictData>()
                ...
                throw new ServiceException(String.format("%1$s已分配,不能删除", dictType.getDictName()), CodeMsg.ERROR);
            }
            //todo 待优化
...
//    @CachePut(cacheNames = CacheNames.SYS_DICT, key = "#dict.dictType")
    ...
    public List<SysDictData> insertDictType(SysDictType dict) {
        ...
        throw new ServiceException("操作失败", CodeMsg.ERROR);
    }
