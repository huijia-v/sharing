package com.huijia.sharing.module.storage.aspect;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.util.ArrayUtil;
import cn.hutool.core.util.StrUtil;
import com.huijia.sharing.core.exception.file.operator.StorageSourceFileOperatorException;
...
public class FileOperatorExceptionWrapperAspect {
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractBaseFileService.newFolder(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractBaseFileService.delete*(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractBaseFileService.rename*(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractBaseFileService.getDownloadUrl(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractBaseFileService.getUploadUrl(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractProxyTransferService.uploadFile(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractProxyTransferService.downloadToStream(..))")
	...
	@AfterThrowing(throwing = "error", value = "execution(public * com.huijia.sharing.module.storage.service.base.AbstractBaseFileService.getFileItem(..))")
