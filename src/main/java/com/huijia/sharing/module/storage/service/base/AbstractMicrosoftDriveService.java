...
import com.huijia.sharing.core.exception.StorageSourceRefreshTokenException;
import com.huijia.sharing.core.exception.ZFileRetryException;
import com.huijia.sharing.core.util.StringUtils;
import com.huijia.sharing.module.storage.constant.StorageConfigConstant;
import com.huijia.sharing.module.storage.model.bo.RefreshTokenCacheBO;
import com.huijia.sharing.module.storage.model.dto.OAuth2TokenDTO;
import com.huijia.sharing.module.storage.model.entity.StorageSourceConfig;
import com.huijia.sharing.module.storage.model.enums.FileTypeEnum;
import com.huijia.sharing.module.storage.model.param.MicrosoftDriveParam;
import com.huijia.sharing.module.storage.model.result.FileItemResult;
import com.huijia.sharing.module.storage.service.StorageSourceConfigService;
...
public abstract class AbstractMicrosoftDriveService<P extends MicrosoftDriveParam> extends AbstractBaseFileService<P> implements RefreshTokenService {
    ...
    public List<FileItemResult> fileList(String folderPath) {
        ...
        do {
            ...
            } else if (SharingConstant.PATH_SEPARATOR.equalsIgnoreCase(fullPath) || "".equalsIgnoreCase(fullPath)) {
    ...
    public boolean newFolder(String path, String name) {
        ...
        if (SharingConstant.PATH_SEPARATOR.equalsIgnoreCase(fullPath) || "".equalsIgnoreCase(fullPath)) {
            requestUrl = DRIVER_ROOT_URL;
        } else {
            requestUrl = DRIVER_ITEMS_URL;
        }
