...
import com.huijia.sharing.module.storage.model.param.WebdavParam;
...
public class WebdavServiceImpl extends AbstractProxyTransferService<WebdavParam> {
	...
	public List<FileItemResult> fileList(String folderPath) throws Exception {
		...
		for (DavResource davResource : resources) {
			if (Objects.equals(StringUtils.concat(requestPath, SharingConstant.PATH_SEPARATOR),
								StringUtils.concat(davResource.getPath(), SharingConstant.PATH_SEPARATOR))) {
				continue;
			}
