...
import com.huijia.sharing.core.exception.StorageSourceAutoConfigCorsException;
...
import com.huijia.sharing.module.storage.model.param.S3BaseParam;
...
public abstract class AbstractS3BaseFileService<P extends S3BaseParam> extends AbstractBaseFileService<P> {
    ...
    public List<FileItemResult> s3FileList(String path) {
        ...
        String fullPath = StringUtils.trimStartSlashes(StringUtils.concat(param.getBasePath(), path, SharingConstant.PATH_SEPARATOR));
    ...
    public boolean newFolder(String path, String name) {
        ...
        String fullPath = StringUtils.concat(param.getBasePath(), path, name, SharingConstant.PATH_SEPARATOR);
